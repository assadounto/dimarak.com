...
export const services: Service[] = [
  {
    ...
    summary:
      "Design and build customer‑grade apps with Next.js, React Native (Expo), and secure Rails/Node APIs.",
    Icon: Rocket,
    highlights: [
    ...
    process: [
      {
        name: "Discover",
        desc: "Stakeholder interviews, constraints, metrics",
      },
    ...
    faqs: [
      {
        q: "Do you handle App Store publishes?",
        a: "Yes. We prepare builds, metadata, and guide approvals.",
      },
      {
        q: "What analytics do you set up?",
        a: "Mixpanel/GA4, error tracking, and dashboards based on your needs.",
      },
    ],
  },
  {
    ...
    title: "AI Enablement",
    summary:
      "Ship useful, safe AI features: RAG search, agents, automations, and guardrails.",
    Icon: Sparkles,
    highlights: [
      "Use‑case discovery",
      "RAG/semantic search",
    ...
    faqs: [
      {
        ...
        a: "Yes. We fit your data sources and comply with your residency and access rules.",
      },
      {
        q: "Which models do you use?",
        a: "We’re model‑agnostic and pick per use‑case, budget, and latency.",
      },
    ],
  },
  {
    ...
    title: "Hardware & IoT",
    summary:
      "Prototype and pilot connected devices with sensors, firmware, cloud APIs, and dashboards.",
    Icon: Cpu,
    highlights: [
      "Sensor selection",
      "Firmware + OTA",
      "Cloud API & device registry",
      "Admin/device dashboards",
    ],
    deliverables: [
    ...
    faqs: [
      {
        ...
        a: "We advise on regulatory steps and can coordinate partners as needed.",
      },
      {
        q: "Can we host on our cloud?",
        a: "Yes. AWS, GCP, or Azure with VPC options.",
      },
    ],
  },
  {
    ...
    summary:
      "Tell the story: motion, product videos, launch assets, and design systems for your product.",
    Icon: Users,
    highlights: [
      "Product videos & motion",
      "Brand & design systems",
      "Websites & launch assets",
    ],
    deliverables: [
    ...
    faqs: [
      {
        ...
        a: "Yes, or we can hand off to your team with docs.",
      },
      {
        q: "Can you localize assets?",
        a: "We can export localized versions for your markets.",
      },
    ],
  },
];
