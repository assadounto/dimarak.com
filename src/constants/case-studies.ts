...
export const allCaseStudies: CaseStudy[] = [
  {
    ...
    industry: 'Logistics',
    timeframe: '6 months',
    summary: 'Rebuilt onboarding, time tracking, and invoice workflows to reduce cycle time and errors.',
    challenge: 'Fragmented spreadsheets and manual reviews slowed billing, caused disputes, and hid bottlenecks.',
    solution:
    ...
    testimonial: { quote: 'Dimarak delivered on time with measurable impact across our billing workflow.', name: 'Y. Mensah', title: 'COO, Logistics Co.' },
  },
  {
    ...
    industry: 'Fintech',
    timeframe: '10 weeks',
    summary: 'Added RAG search and agent handoffs to deflect tickets while improving CSAT and response times.',
    challenge: 'Support team struggled to find accurate answers quickly, leading to longer SLAs and lower CSAT.',
    solution:
    ...
    outcomes: ['41% ticket deflection', 'CSAT +12 pts', 'Median first response −38%'],
    metrics: [
    ...
    stack: ['Next.js', 'Node', 'Postgres', 'OpenAI/Anthropic', 'LangChain/Evals'],
    testimonial: { quote: 'Reliable partner for AI features — we shipped safely and fast.', name: 'S. Boateng', title: 'VP Eng, Fintech' },
  },
  {
    ...
    industry: 'Healthcare',
    timeframe: '12 weeks',
    summary: 'Prototyped sensor devices, telemetry pipeline, and compliance dashboards for vaccine fridges.',
    challenge: 'Manual temperature logs missed excursions; compliance risk and spoilage costs were high.',
    solution:
    ...
    outcomes: ['Compliance +19 pts', 'Spoilage −24%', 'Alert response within 10 min'],
    metrics: [
...
export function getRelatedCases(cs: CaseStudy, take = 3) {
  return allCaseStudies
    .filter((c) => c.slug !== cs.slug && (c.industry === cs.industry || c.services.some((s) => cs.services.includes(s))))
    .slice(0, take)
}
